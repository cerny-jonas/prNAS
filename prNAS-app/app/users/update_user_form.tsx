...
import { HandleUpdateUserFormData, updateUserFormData } from "./update_user_handler"
...
const UpdateUserForm = () => {
    ...
    const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const formData: updateUserFormData = { username: username, password: password }
            await HandleUpdateUserFormData(formData)
        } catch (error: any) {
