...
import { HandleDeleteUserFormData, deleteUserFormData } from "./delete_user_handler"
...
const DeleteUserForm = () => {
    ...
    const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const formData: deleteUserFormData = { username: username }
            await HandleDeleteUserFormData(formData)
        } catch (error: any) {
